...
/**
 * Classe da camada de serviço do Product
 */
public class ProductService {

	@Autowired //Para o spring fazer a injeção de dependência
	//Declarar dependência do ProductRepository
	 ...
	 * @return Retorna o resultado da solicitação ao repository do retorno do Product por ID */
