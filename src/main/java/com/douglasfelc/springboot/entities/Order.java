...
public class Order implements Serializable {
	...
	private Integer orderStatus; //Define como interno para gravar desta forma no banco de dados
	
	@ManyToOne
	@JoinColumn(name = "client_id")
	private User client;

	@OneToMany(mappedBy = "id.order") //No OrderItem tem o id, e no id tem o order
